...
public class ComandosDao {
	...
	public ArrayList<Comando> getAll(){
		...
		comandos.add(csc);
		Comando cs = new Comando("Verificar Configura��o", "G",R.drawable.verifica);
		comandos.add(cs);
		...
		for(Comando c : comandos){
			c.setDescricao("Lorem ipsum dolor sit amet, " +
					"consectetur adipiscing elit. Cras vitae commodo leo, " +
					"non tincidunt ipsum. Class aptent taciti sociosqu ad " +
	...
	public Comando getOne(String id){
		ArrayList<Comando> comandos = new ArrayList<Comando>();
		Comando l = new Comando("Localizar", "F",R.drawable.locate);
		comandos.add(l);
		Comando lm = new Comando("Localizar com Mapa", "FM",R.drawable.locate_map);
		lm.setDescricao("No SMS de resposta, clique no link para abrir o mapa da localiza��o.");
		comandos.add(lm);
		Comando mb = new Comando("Motor Bloquear", "D",R.drawable.enginec);
		mb.setDescricao("Bloqueia, desliga, o motor ou igni��o do ve�culo (conforme foi feita a liga��o el�trica).");
		comandos.add(mb);
		Comando md = new Comando("Motor Desbloquear", "E",R.drawable.engine);
		md.setDescricao("Desbloqueia, libera, o motor ou igni��o do ve�culo (conforme foi feita a liga��o el�trica).");
		comandos.add(md);
		Comando ea = new Comando("Escuta Ativar", "P1",R.drawable.escuta);
		ea.setDescricao("Ativa a fun��o para escutar a conversa interna. \n Apos ativa a fun��o basta fazer uma liga��o telef�nica para o rastreador para abrir a escuta.");
		comandos.add(ea);
		Comando ed = new Comando("Escuta Cancelar", "P0",R.drawable.escutac);
		ed.setDescricao("Desativa a fun��o escuta.");
		comandos.add(ed);
		Comando tc1 = new Comando("1� Telefone Cadastrar", "A1",R.drawable.phone1a);
		tc1.setDescricao("Cadastra na mem�ria do rastreador o telefone na posi��o 1.");
		comandos.add(tc1);
		Comando ta1 = new Comando("1� Telefone Apagar", "A0",R.drawable.phone1d);
		ta1.setDescricao("Apaga da mem�ria do rastreador o telefone na posi��o 1.");
		comandos.add(ta1);
		Comando tc2 = new Comando("2� Telefone Cadastrar", "B1",R.drawable.phone2a);
		tc2.setDescricao("Cadastra na mem�ria do rastreador o telefone na posi��o 2.");
		comandos.add(tc2);
		Comando ta2 = new Comando("2� Telefone Apagar", "B0",R.drawable.phone2d);
		ta2.setDescricao("Apaga da mem�ria do rastreador o telefone na posi��o 2.");
		comandos.add(ta2);
		Comando tc3 = new Comando("3� Telefone Cadastrar", "C1",R.drawable.phone3a);
		tc3.setDescricao("Cadastra na mem�ria do rastreador o telefone na posi��o 3.");
		comandos.add(tc3);
		Comando ta3 = new Comando("3� Telefone Apagar", "C0",R.drawable.phone3d);
		ta3.setDescricao("Apaga da mem�ria do rastreador o telefone na posi��o 3.");
		comandos.add(ta3);
		Comando sa = new Comando("Senha Alterar", "G",R.drawable.password);
		...
		ca.setDescricao("Ativa e configura a cerca eletrônica.\n"+
				"É poss�vel configurar 3 cercas eletrônicas diferentes.\n"+
		...
		comandos.add(cbd);
		Comando aja = new Comando("Anti Jammer Ativar", "JDR1",R.drawable.jammer);
		aja.setDescricao("Ativa a função anti Jammer.");
		comandos.add(aja);
		Comando ajd = new Comando("Anti Jammer Cancelar", "JDR0",R.drawable.jammern);
		...
		comandos.add(cs);
		Comando gprsa = new Comando("Salva GPRS Ativar", "Y1",R.drawable.gprs);
		gprsa.setDescricao("Quando o veículo está também operando através do site localizevoce, quando ativa essa função, quando o veículo for desligado, o rastreador irá parar de enviar as informações para o site após 5 minutos, quando o veículo for ligado novamente o rastreador voltará a enviar as informações. Essa função evita o consumo de dados do chip gsm e também evitará a geração de grande histórico e relatório com registros desnecessários. Poderá auxiliar no não bloqueio do chip gsm, pois quando existe muito trafego de dados as operadoras costumam bloquear o chip gsm.");
		comandos.add(gprsa);
		Comando gprsd = new Comando("Salva GPRS Cancelar", "Y0",R.drawable.gprs);
		gprsd.setDescricao("Cancela a função Salva GPRS, e se o rastreador estiver operando também atraves do site localizevoce, o rastreador poderá sempre transmitir os dados, NÃO ACONSELHAMOS que seja cancelada a função, pois a função evitará histórico e relatório com dados desnecessários.");
		comandos.add(gprsd);
		Comando rs = new Comando("Reset", "RESET!",R.drawable.undo);
	...
	public ArrayList<Comando> listAllComandos() {
		ArrayList<Comando> comandos = new ArrayList<Comando>();
